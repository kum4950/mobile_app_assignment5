...
public class ActivityRequest extends StringRequest {
    ...
    final static private String URL = "http://10.0.2.2:8080/Gym/updateview.php";
    private Map<String, String> parameters;

    //생성자
    public ActivityRequest(String video_name, int views, Response.Listener<String> listener){
        super(Method.POST, URL, listener, null);
        parameters = new HashMap<>();
        parameters.put("video_name", video_name);
